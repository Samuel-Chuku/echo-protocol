  ...
  return (
    <nav className="border-b border-white/[0.08] bg-ink/80 backdrop-blur sticky top-0 z-30">
      <div className="max-w-6xl mx-auto px-5 sm:px-6 flex items-center h-16">
        ...
        {/* USDC balance + bell + wallet + profile avatar, pinned right (#4). Desktop/tablet only. */}
        <div className="hidden md:flex ml-auto">
          <WalletStatus />
        </div>

        {/* Mobile: hamburger opens the slide-down drawer below. */}
        <button
      ...
      {/* Mobile drawer: full-width, slides down from under the nav bar. */}
      <div
