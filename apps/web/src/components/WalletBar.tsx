...
/** Persistent top bar: the RainbowKit connect button (single button → all-wallets modal), plus the
 *  console essentials — identity registration and the USDC approvals that gate most write commands. */
  ...
  return (
    <div className="border-b border-gray-200 bg-gray-50">
      <div className="max-w-6xl mx-auto px-6 py-3 flex flex-wrap items-center gap-x-6 gap-y-2 text-sm">
        {/* one button → RainbowKit modal with every wallet + Circle (when configured) */}
